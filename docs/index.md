...
- deterministic timeslice rendering
...
- Use [Installation](installation.md) to get the package into an environment.
- Use [Quickstart](quickstart.md) for the fastest library and CLI examples.
- Use [Usage Examples](USAGE_EXAMPLES.md) for command-line practice recipes.
- Use [API Reference](api/index.md) for the generated code-level surface.
